    ...
    <div class="main-layout">
      ...
      <main class="content-area">
        ...
        <div class="main-content-panel">
          ...
          <div v-else-if="activeNavItem === '课程资源'">
            <TeachingResources />
          </div>
          <div v-else-if="activeNavItem === '教案管理'">
            <LessonPlanManagement :courseId="courseId" />
          </div>
          <div v-else-if="activeNavItem === '备课资料'">
            <LessonPlanGenerator :courseId="courseId" />
          </div>
...
import LessonPlanManagement from "@/components/teacher/LessonPlanManagement.vue";
...
const navItems = ref([
  ...
  { name: "课程资源", icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" },
  { name: "备课资料", icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
  { name: "教案管理", icon: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" },
]);

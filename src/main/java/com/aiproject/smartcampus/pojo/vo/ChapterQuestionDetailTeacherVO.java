...
@AllArgsConstructor
@Builder
public class ChapterQuestionDetailTeacherVO {
    /**
     * 题目ID
     */
     ...
     * @return 章节题目类型中文描述
     */
    public String getChapterQuestionTypeCn() {
        if (chapterQuestionType == null) {
            return "测试题";
        }
        switch (chapterQuestionType.toLowerCase()) {
            case "practice":
                return "练习题";
            case "test":
                return "测试题";

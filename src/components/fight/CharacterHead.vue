...
.top-bar {
  ...
  height: 70px;
  background: 
    linear-gradient(to bottom, #0a0805, #1a140f),
...
.crown-icon {
  ...
  height: 25px;
  background: 
    url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35 25"><path d="M0,20 L5,10 L10,15 L15,5 L20,15 L25,10 L30,20 Z" fill="%23d4af37"/><circle cx="7" cy="10" r="2" fill="%23ff0000"/><circle cx="17.5" cy="5" r="2" fill="%23ff0000"/><circle cx="28" cy="10" r="2" fill="%23ff0000"/></svg>');
...
.level-decoration {
  ...
  height: 50px;
  background: 
    url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50"><path d="M25,0 Q40,10 50,25 Q40,40 25,50 Q10,40 0,25 Q10,10 25,0 Z" fill="none" stroke="%23d4af37" stroke-width="1.5"/></svg>');
  background-size: contain;
...
.stairs-icon {
  ...
  height: 30px;
  background: 
    url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30"><path d="M0,30 L5,25 L10,30 L15,25 L20,30 L25,25 L30,30 L30,25 L25,20 L20,25 L15,20 L10,25 L5,20 L0,25 Z M0,20 L5,15 L10,20 L15,15 L20,20 L25,15 L30,20 L30,15 L25,10 L20,15 L15,10 L10,15 L5,10 L0,15 Z M0,10 L5,5 L10,10 L15,5 L20,10 L25,5 L30,10 L30,5 L25,0 L20,5 L15,0 L10,5 L5,0 L0,5 Z" fill="%23a08060"/></svg>');
  background-size: contain;
  filter: drop-shadow(0 3px 3px rgba(0, 0, 0, 0.7));
...
.exit-button {
  position: relative;
  background: 
    linear-gradient(to bottom, #5a0a0a, #3a0000),
...
.exit-button:hover {
  background: 
    linear-gradient(to bottom, #7a0a0a, #5a0000),
...
.skull-icon {
  ...
  height: 30px;
  background: 
    url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30"><circle cx="15" cy="12" r="8" fill="%23aaa"/><path d="M10,18 Q15,23 20,18 Q18,21 15,21 Q12,21 10,18 Z" fill="%23aaa"/><circle cx="11" cy="10" r="2.5" fill="%23000"/><circle cx="19" cy="10" r="2.5" fill="%23000"/></svg>');
  background-size: contain;
...
.exit-button::before {
  ...
  height: 20px;
  background: 
    url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M10,0 Q15,8 20,20 Q8,15 0,20 Q5,8 10,0 Z" fill="%23a00"/></svg>');
  background-size: contain;
  opacity: 0.8;
...
.floating-runes::before {
  ...
  height: 40px;
  background: 
    url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 40"><text x="0" y="20" font-family="Medieval" font-size="20" fill="%23d4af37" opacity="0.3">ᚠ ᚢ ᚦ ᚨ ᚱ ᚲ ᚷ ᚹ ᚺ ᚾ ᛁ ᛃ ᛇ ᛈ ᛉ ᛊ ᛏ ᛒ ᛖ ᛗ ᛚ ᛜ ᛟ ᛞ</text></svg>');
  background-size: contain;
...
.shadow-wraiths::after {
  ...
  height: 100px;
  background: 
    url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80 100"><path d="M40,0 Q60,20 80,40 Q60,60 40,80 Q20,60 0,40 Q20,20 40,0 Z" fill="%23000" opacity="0.3"/></svg>');
  background-size: contain;

...
<template>
  ...
  .modal-overlay {
    ...
    width: 100%;
    height: 100%;
    background: radial-gradient(ellipse at center, rgba(8, 0, 15, 0.7), rgba(3, 0, 8, 0.9));
  ...
  .modal-container {
    ...
    max-width: 90%;
    background: 
      linear-gradient(135deg, rgba(30, 10, 30, 0.8), rgba(50, 15, 35, 0.7)),

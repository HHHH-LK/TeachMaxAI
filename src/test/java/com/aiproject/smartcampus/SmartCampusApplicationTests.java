...
class SmartCampusApplicationTests {
    ...
    @Test
    void ABTest() throws IOException {

        JavaRAGABTestIntegration.runJavaRAGABTest(handler, contentRetriever, chatLanguageModel);
        System.out.println("测试已经完成");
    ...
    void test11() throws IOException {
        ...
        String conterver = handler.executeBusinessLogic("Java基础语法", null);

        System.out.println(conterver);
    }
